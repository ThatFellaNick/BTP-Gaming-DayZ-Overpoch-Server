...
if (isNil "keyboard_keys") then {
	...
	_custommenu = {if (isNull findDisplay 7777) then {
		execVM "scripts\menu\menu_init.sqf";
		};
		_handled = true;
	};
	...
	[[DIK_F3], {if (isNull findDisplay 7777) then {
		execVM "scripts\menu\menu_init.sqf";
		};
		_handled = true;}] call _addArray;
	...
	[[DIK_U], _muteSound] call _addArray;
