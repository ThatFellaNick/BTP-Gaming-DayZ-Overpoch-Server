...
_serverName = "BTP Gaming"; // the server name that will go accross the top of the menu

_ts3IP = "TS3 - ts.btpgaming.com"; // ts3 ip that will go at the bottom of the menu

_websiteUrl = "www.btpgaming.com"; // website url that goes at the bottom of the menu 
...
_action1Text = "Hide/Show Debug Monitor"; //Text that will go on action button 1
action1script = {((ctrlParent (_this select 0)) closeDisplay 7777); execvm 'scripts\CustomDebugMonitor\hide_show.sqf';}; //script that action button 1 will use

_action2Text = "Flip Vehicle"; //Text that will go on action button 2
action2script = {((ctrlParent (_this select 0)) closeDisplay 7777); execvm 'scripts\FlipVehicle\flip_veh.sqf';}; //script that action button 2 will use

_info1Text = "Grass On/Off"; //Text that will go on info button 1
info1script = {((ctrlParent (_this select 0)) closeDisplay 7777); execvm 'scripts\MenuGrass\grassoff.sqf';}; //script that info button 1 will use

_info2Text = "Group Management"; //Text that will go on info button 2
info2script = {((ctrlParent (_this select 0)) closeDisplay 7777); execvm 'scripts\DZGMInvoker\CallDZGM.sqf';}; //script that info button 2 will use

_info3Text = "Deploy Bike"; //Text that will go on info button 3
info3script = {((ctrlParent (_this select 0)) closeDisplay 7777); execvm 'dayz_code\scripts\deploybike.sqf';}; //script that action info 3 will use
...
_deployable1Text = ""; //Text that will go on deployable button 1
_deploy1item1Text = ""; //Text that will go in the number 1 item slot under the first deploy button 
...
_deployable2Text = ""; //Text that will go on deployable button 2
...
_deployable3Text = ""; //Text that will go on deployable button 3
