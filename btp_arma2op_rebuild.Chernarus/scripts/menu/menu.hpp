...
class slk_view5: slkRscButton
{
	...
	h = 0.022 * safezoneH;
	colorBackground[] = {0.047,0.376,0.776,1};
	onButtonClick = "setViewDistance 6000; systemChat('ViewDistance: 6000');";
};
class slk_view6: slkRscButton
{
	idc = 1605;
	text = "7000"; //--- ToDo: Localize;
	x = 0.443281 * safezoneW + safezoneX;
	y = 0.511 * safezoneH + safezoneY;
	w = 0.113437 * safezoneW;
	h = 0.022 * safezoneH;
	colorBackground[] = {0.047,0.376,0.776,1};
	onButtonClick = "setViewDistance 7000; systemChat('ViewDistance: 7000');";
};
class slk_view7: slkRscButton
{
	idc = 1606;
	text = "8000"; //--- ToDo: Localize;
	x = 0.443281 * safezoneW + safezoneX;
	y = 0.555 * safezoneH + safezoneY;
	w = 0.113437 * safezoneW;
	h = 0.022 * safezoneH;
	colorBackground[] = {0.047,0.376,0.776,1};
	onButtonClick = "setViewDistance 8000; systemChat('ViewDistance: 8000');";
};
class slk_view8: slkRscButton
{
	idc = 1607;
	text = "9000"; //--- ToDo: Localize;
	x = 0.443281 * safezoneW + safezoneX;
	y = 0.599 * safezoneH + safezoneY;
	w = 0.113437 * safezoneW;
	h = 0.022 * safezoneH;
	colorBackground[] = {0.047,0.376,0.776,1};
	onButtonClick = "setViewDistance 9000; systemChat('ViewDistance: 9000');";
};
class slk_view9: slkRscButton
{
	...
	h = 0.022 * safezoneH;
	colorBackground[] = {0.047,0.376,0.776,1};
	onButtonClick = "setViewDistance 10000; systemChat('ViewDistance: 10000');";
};
