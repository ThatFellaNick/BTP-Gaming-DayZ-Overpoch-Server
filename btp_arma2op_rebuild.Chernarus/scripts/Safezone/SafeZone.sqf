...
_infiSZ =
[
        [[6325.6772,7807.7412,0],100,true],
        [[4063.4226,11664.19,0],100,true],
        [[11447.472,11364.504,0],100,true],
        [[1606.6443,7803.5156,0],100,true],
        [[12944.227,12766.889,0],100,true],
		[[3238.29,3382.33,0],120,true]
];
        ...
        {
                {
                        ...
                        if (_lSign) then
                        {
                                for '_i' from 0 to 360 step (270 / _radius)*2 do
                                {
                                        ...
                                        //		_object setVehicleInit 'this setObjectTexture [0,''Scripts\Safezone\sign.paa''];';
                                        _object setDir _dir;
                                };
                        };
                } forEach _infiSZ;
...
[_infiSZ] spawn {
        ...
        _startSafeZone =
        {
                ...
                player_fired = {
                        ...
                        systemChat format['[BTP] You can not fire in a SafeZone!'];
						format["[BTP] You can not fire in a SafeZone!"] call dayz_rollingMessages;
                };
                zombie_generate = {};
                ...
                [
                        ...
                        'MeleeHatchet','MeleeHatchet','MeleeCrowbar','MeleeMachete','MeleeFishingPole','MeleeSledge',
                        'MeleeBaseBallBatNails','MeleeBaseBallBatBarbed','MeleeBaseBallBat','SMAW','Throw','Strela','Igla'
                ];
