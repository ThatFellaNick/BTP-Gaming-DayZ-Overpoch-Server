...
/*  LOW ADMIN HERE        */ _LAdmins = ["76561198211887613","0"]; //do not have a , at the end.
/*  NORMAL ADMIN HERE     */ _NAdmins = ["76561198194311977","76561198155388519","76561198060304541","76561198254593024","76561198171023638","76561198081322477","76561198079210786","76561198316589366","76561198122507482"]; //do not have a , at the end.
/*  SUPER ADMIN HERE      */ _SAdmins = ["76561198203547148","76561197987543308","76561198086444982","76561198075210163","76561198213884255","76561198154223981","76561198154936489","76561198115007530","76561198353159020","76561198150005276","76561198316589366","76561197971162938","76561198074925233","76561198066441861","76561198120974983"]; //Last UID belongs to fini
...
/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = "BTP Overpoch"; //do not use " in this text.
/*  Bottom esc menu TXT   */ _LowerTop = "www.btpgaming.com"; //do not use " in this text.
/*  Bottom esc menu TXT2  */ _LowerBottom = "ts.btpgaming.com"; //do not use " in this text.
/*  Color esc menu TXT    */ _EscColor = [0.867,0.365,0.145,1];
/*  DebugMonitor TXT      */ _BottomDebug = "BTP Overpoch #2"; //do not use " in this text.
...
/*  Force Terrain Grid ?  */ _FTG = false;	/* 50, 25, 12.5  */	/* if set to 50 grass will be very low for better client FPS.. default is 25 */
...
[
	...
	"s_player_upgradestorage","s_player_upgradestroage","s_player_warndog","s_player_waterdog","s_player_zombieShield","s_player3089_copyToKey",
...
_magazines1 = [
	['metal_floor_kit','cinder_wall_kit'],
	[100,100]
];
_backpack1 = [
	[],
