...
[[(_coords select 0) - 10.5005,(_coords select 1) - 2.6465,0],4,1,"HeroUnits","hero","hero"] call AISpawn;
sleep 5;
[[(_coords select 0) + 4.7027,(_coords select 1) + 12.2138,0],4,1,"HeroUnits","hero","hero"] call AISpawn;
sleep 5;
...
diag_log text format["[AI Missions]: Hero C130 Mission has Ended."];
