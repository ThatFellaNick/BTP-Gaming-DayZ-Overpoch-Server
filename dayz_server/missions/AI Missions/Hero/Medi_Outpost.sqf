...
[[(_coords select 0) - 20, (_coords select 1) - 15,0],3,0,"HeroUnits","hero","hero"] call AISpawn;
sleep 3;
[[(_coords select 0) + 10, (_coords select 1) + 15,0],3,0,"HeroUnits","hero","hero"] call AISpawn;
sleep 3;
