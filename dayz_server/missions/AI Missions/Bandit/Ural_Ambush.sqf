...
[[(_coords select 0) - 6.9458,(_coords select 1) - 3.5352, 0],3,1,"BanditUnits","bandit","bandit"] call AISpawn;
sleep 5;
[[(_coords select 0) + 4.4614,(_coords select 1) + 2.5898, 0],3,1,"BanditUnits","bandit","bandit"] call AISpawn;
sleep 5;
