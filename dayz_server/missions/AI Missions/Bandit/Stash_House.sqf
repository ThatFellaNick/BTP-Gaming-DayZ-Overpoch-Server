...
[[(_coords select 0) - 4.0796, (_coords select 1) - 11.709,0],3,2,"BanditUnits","bandit","bandit"] call AISpawn;
sleep 3;
[[(_coords select 0) + 2.8872, (_coords select 1) + 18.964,0],3,2,"BanditUnits","bandit","bandit"] call AISpawn;
sleep 3;
