...
[[(_coords select 0) - 10.5005,(_coords select 1) - 2.6465,0],4,1,"BanditUnits","bandit","bandit"] call AISpawn;
sleep 5;
[[(_coords select 0) + 4.7027,(_coords select 1) + 12.2138,0],5,1,"BanditUnits","bandit","bandit"] call AISpawn;
sleep 5;
