if(isServer) then {
	...
	[[_position select 0,_position select 1,0],_rndnum,"Easy",["Random","AT"],2,"Random","Hero","Random","Hero",_mission] call spawn_group;

	for "_i" from 0 to _rndgro do {
		[[_position select 0,_position select 1,0],_rndnum,"Easy","Random",2,"Random","Hero","Random","Hero",_mission] call spawn_group;
	};
